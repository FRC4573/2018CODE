	...
	public void retractClimber(){
     ...
     // ***************************************************************************
		...
		public void autoInit() 	{
			...
			autoTemp = SmartDashboard.getString("DB/String 7", "1");  // Default = program 1 if none selected
			if (autoTemp == null || autoTemp.equals("")){
				autoTemp ="0";
				System.out.println("AutoInit - Null-2"); 
			}
			autoProg = Character.getNumericValue(autoTemp.charAt(0)); // Convert to numeric
			autoMap = SmartDashboard.getString("DB/String 5", "R");  // Default = Right if none selected
			if (autoMap==null || autoMap.equals("")){
				autoMap ="R";
				System.out.println("AutoInit - Null-3"); 
			}
			autoMap += Character.toString(gameData.charAt(0)); 
