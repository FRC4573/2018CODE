...
public class Robot extends TimedRobot {
	...
	//	m_rearRight.setSafetyEnabled(false);
		...
		seqState = 'E';
		autoSeq = "E0";
		SmartDashboard.putString("DB/String 0","E0");
		updateDisplays();
	...
	// 5Secs = 11ft
		switch(autoMap) {
			case "LL":{
				autoSeq = "D6R2D1E0";  // fix this line
				//autoSeq = "DxR2Dy";
				break;
			}
			case "LR":{
				autoSeq = "D1R2D1L2D1L2D1E0";
				//autoSeq = "DxR2DyL2DzL2Dw";
				break;
			}
			case "CL":{
				autoSeq = "D1L2D1R2D1R2D1E0";
				//autoSeq = "DxL2DyR2DzR2Dw";
				break;
			}
			case "CR":{
				autoSeq = "D1R2D1L2D1L2D1E0";
	...
	public void retractClimber(){
     ...
     // ***************************************************************************
		...
		//
		// Example: D2R2W3E0 = Drive Fwd 2 secs, Turn Right 90 Deg, Wait 3 secs, End 
	    // ***************************************************************************
